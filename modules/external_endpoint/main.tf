...
resource "azapi_resource" "this" {
  ...
  type      = var.resource_types.network_trafficmanagerprofiles_external_endpoints
  body = {
    properties = {
  ...
  ignore_body_changes    = length(var.ignore_body_changes.network_trafficmanagerprofiles_external_endpoints) > 0 ? var.ignore_body_changes.network_trafficmanagerprofiles_external_endpoints : null
